...
const AddItem = ({ addItem }) => {
    ...
    return (
        <View>
            <TextInput style={styles.input} placeholder="Add Item..." onChangeText={(val) => setText(val)} value={text} />
            <TouchableOpacity style={styles.btn} onPress={() => { addItem(text.charAt(0).toUpperCase() + text.slice(1)); setText('') }}>
